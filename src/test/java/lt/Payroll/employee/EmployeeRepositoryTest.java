...
//Employee lt.Payroll.employee = new Employee("Jonas", "Jonukas", "Jonaitis");

//employeeDAO.createEmployee(lt.Payroll.employee);
// assertThat(???);
    //assertEntityCreatedInDB(lt.Payroll.employee);
//Mockito.verify(employeeDAO, Mockito.times(1)).createEmployee(lt.Payroll.employee);
