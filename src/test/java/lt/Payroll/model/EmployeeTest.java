...
import jpa.unitTesting.AssertAnnotations;
...
class EmployeeTest {
    ...
    @Test
    public void Employee_Class_Have_Entity_Annotation() {
        assertTrue(Employee.class.isAnnotationPresent(Entity.class));
    }

    @Test
    public void Employee_Class_Have_Data_Annotation() {
        assertTrue(Employee.class.isAnnotationPresent(Data.class));
    }

    @Test
    public void Employee_Class_Have_Table_Annotation() {
        assertTrue(Employee.class.isAnnotationPresent(Table.class));
        assertTrue(Employee.class.getAnnotation(Table.class).name()!= null);
    }
